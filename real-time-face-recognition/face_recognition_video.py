...
def recognize_faces_in_video(video_path):
    # Absolute path for trainer.yml
    trainer_yml_path = r"C:\Users\hamda\OneDrive\Documents\GitHub\INSIGHT_X\trainer.yml"  # Update with the actual path
    ...
    names_path = r"C:\Users\hamda\OneDrive\Documents\GitHub\INSIGHT_X\names.json"
    if not os.path.exists(names_path):
        print("[ERROR] Names file 'names.json' not found.")
        return

    # Face detection model paths
    proto_path = r"C:\Users\hamda\OneDrive\Documents\GitHub\INSIGHT_X\real-time-face-recognition\deploy.prototxt"
    model_path = r"C:\Users\hamda\OneDrive\Documents\GitHub\INSIGHT_X\real-time-face-recognition\res10_300x300_ssd_iter_140000.caffemodel"
...
video_path = r"C:\Users\hamda\OneDrive\Documents\GitHub\INSIGHT_X\abc.mp4"  # Corrected path
